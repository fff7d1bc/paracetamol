...
var byApplication = map[string][]Recipe{
	...
	"llama-cpp": {
		...
		{ID: "qwen3.8-flash-next", Application: "llama-cpp", Description: "Qwen3.8 Flash-Next 125B-A6B Dynamic IQ4_XS for experimental Strix Halo SSD-backed loading", Bundles: []string{"llama-qwen3.8-flash-next-125b-a6b-ud-iq4-xs"}, Next: []string{"run", "llama-cpp", "server", "--preset", "qwen3.8-flash-next-125b-a6b-ud-iq4-xs"}},
